...
<div class="container">
<h2 class="col-sm-offset-5 col-sm-10">약관동의</h2>
 <form class="form-horizontal" method="post" 
       action="createForm.jsp" onsubmit="return send();" name="frm">
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  </textarea>
  ...
  <div class="form-group">
   <div class="col-sm-offset-2 col-sm-5">
    <input  type="checkbox" name="agree" value="1"  id="agree"><label for="agree">약관에 동의합니다</label>
